...
public class Tweener : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        else if (_transform != null)
        {
            ...
            _tweenObject = LeanTween.move(_transform, dest, _duration);
        }
    }
    ...
    private void Rotate()
    {
        ...
        else if (_transform != null)
        {
            ...
            _tweenObject = LeanTween.rotate(_transform, dest, _duration);
        }
    }
    ...
    private void Scale()
    {
        ...
        else if (_transform != null)
        {
            ...
            _tweenObject = LeanTween.scale(_transform, dest, _duration);
        }
    }
